...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[85vh] overflow-hidden sm:min-h-[90vh]" aria-label="Hero">
      ...
      <div className="relative z-10 flex min-h-[85vh] flex-col justify-center px-4 py-20 text-white sm:min-h-[90vh] sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            ...
            <a
              href="#request-cab"
              className="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-white bg-transparent px-4 py-2.5 text-sm font-medium text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent"
            >
              Request a Cab
            </a>
          </div>
